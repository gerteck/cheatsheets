...
\begin{itemize}
  \item \textbf{Antenna size is inversely proportional to frequency}: higher frequency $\Rightarrow$ smaller antenna; lower frequency $\Rightarrow$ larger antenna. Follows from wavelength $\lambda = c/f$.
  \begin{itemize}
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    $P_r$ is received power, $P_t$ is transmitted power.
    \item $G_t, G_r$ are antenna gains, $d$ is distance, $\alpha$ is path loss exponent ($\alpha = 2$ for free space LoS), $c$ is speed of light, $f_c$ is carrier frequency.
  ...
  \end{itemize}
  \item \textbf{Case Study}: Balloon vs. Satellite Using balloons (Google Project Loon) at 20km altitude instead of satellites at 400km offers lower latency, requires less transmit power, crucial for battery life of IoT device. An IoT device with a sensitivity of -100 dBm can communicate with a balloon 20km away using only 5.3mW of power, whereas a satellite link would require significantly more energy.
\end{itemize}
...
\begin{itemize}
  \item \textbf{Modulation}: process of encoding information onto a carrier wave / signal by varying its properties (amplitude, frequency, phase). Enables transmission of data over wireless channels.
\end{itemize}
...
% \subsubsection{Fundementals of electromagnetic waves}
\begin{itemize}
...
% \subsubsection{Radio Terminology}
...
% \subsubsection{How radio waves radiate out from transceiver}
% \begin{itemize}
...
% \includegraphics*[width=8.5cm, height=2.8cm]{antennadirection.png}

% \subsubsection{Types of antennas}
% \begin{enumerate}
...
\subsubsection{Relationship between antenna size and frequency}
...
\subsubsection{Performance of an antenna}
\begin{itemize}
...
% \subsubsection{How do radio waves propagate from TX to RX}
...
% \subsubsection{Radio waves propagation in line-of-sight}
% \begin{itemize}
...
% \subsubsection{Non Line-of-sight}
% \begin{itemize}
...
% \subsubsection{Radiation pattern of antenna}
% \begin{itemize}
...
% \includegraphics*[width=8.5cm, height=2.8cm]{radiationpattern.png}

% \subsubsection{Understanding the antenna beamwidth}
% \begin{itemize}
...
\subsubsection{Choosing Beamwidth: Tradeoffs}
\begin{itemize}
...
\subsubsection{Attenuation and Gain: Decibel (dB) unit}
\begin{itemize}
...
\subsubsection{Estimating received signal strength and range: Friis propagation model}
\begin{multicols}{2}
  \begin{center}
    \[
...
\subsubsection{Free Space Path Loss | $FPSL (\text{linear}) = {\frac{4\pi d f }{c}}^2$}
\begin{itemize}
...
\subsubsection{Total link gain in wireless communication}
\begin{itemize}
...
\subsubsection{Link Budget and Total Link Gain}
\begin{itemize}
...
\subsubsection{dB, dBm and dBi operations}
\begin{itemize}
