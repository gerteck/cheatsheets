...
\subsection{Multiple Access Control Protocols for Wireless Networks}
\begin{itemize}
  \item Wired networks: reliable, physically isolated. Consistent throughput, low packet loss.
  \item Lack of wires introduces variability, unreliability, vulnerability to interference
...
\subsection{Medium Access Control for Internet of Things}
\begin{itemize}
...
\subsection{Duty Cycled MAC Protocols}
\subsection{ALOHA with Preamble Sampling}
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item Once preamble detected, receiver stays awake, receives the actual data, acknowledges.
  \end{itemize}
  \centerline{\includegraphics[width = 0.95\linewidth]{preambleSampling.jpg}}
