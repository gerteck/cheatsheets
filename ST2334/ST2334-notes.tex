...
\end{itemize}
\centerline{\includegraphics[width=0.5\linewidth]{pointintervalestimate}}
...
\end{itemize}
\smallskip
\centerline{\includegraphics[width=0.5\linewidth]{unbiasedestimator}}
\textbf{Example}
\begin{itemize}
...
\smallskip
\centerline{\includegraphics[width=0.85\linewidth]{tDistTable}}
