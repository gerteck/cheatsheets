...
\begin{itemize}
    ...
    \item \textbf{Population}{All possible observations of survey}
...
\begin{itemize}
    ...
    \item \textbf{Simple Random Sample}{Given sample of size $n$, each sample has equal chance of being selected}
\end{itemize}
...
\begin{itemize}
    \item \textbf{Statistic}{Suppose random sample of $n$ observations is $X_1, X_2, \cdots, X_n$. A statistic is a function of $X_1, \cdots, X_n$}
    ...
    \item \textbf{Sample Distribution}{Distribution of a statistic}
    ...
    \item \textbf{Standard Error}{Standard deviation of sampling distribution (e.g. $\sigma_{\bar{X}}$)}
