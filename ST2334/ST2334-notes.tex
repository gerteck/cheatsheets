...
% DISCRETE ==============
\section{4. Special Probability Distributions}
\begin{itemize}
...
\subsection{Negative Binomial Distribution ($k^{th}$ success)}
\begin{itemize}
...
\subsection{Geometric Distribution (till $1^{st}$ success)}
\begin{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Upper Quantile}{Given $\alpha$ is upper-tail percentage. The $\alpha$th upper quantile is $x_\alpha$ that satisfies:}
