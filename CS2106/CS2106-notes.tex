...
\item \textbf{Virtual parallelism}: Illusion of parallelism (psedoparallelism)
\item \textbf{Physical parallelism}: Multiple CPUs/Cores, mutliple parallel exec
\end{itemize}
...
\textbf{Criteria}: Response time (time btwm request \& response). Predictability (Less variation in response time). \\
