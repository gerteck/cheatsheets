...
\begin{itemize}
\item For  $\pi_{L}(R)$, we build a \textbf{main-memory hash table} T to detect and remove duplicates.
\item Cost = |R| if T fits in main memory.
\item \textbf{Two Phases}: Partitioning phase and Duplicate Elimination phase.
\end{itemize}
\centerline{\includegraphics[width = 0.8\linewidth]{hashBasedPhases}}
\smallskip

\textbf{Overview of Hash-based Approach}
\centerline{\includegraphics[width = 1\linewidth]{hashBased}}
\smallskip

\textbf{Overview of Partition Phase, Duplicate Elimination Phase}
\centerline{\includegraphics[width = 1\linewidth]{hashBasedPhases2}}

\subsubsection{Illustration of Partitioning Phase}
\centerline{\includegraphics[width = 1\linewidth]{partitioningPhase}}
