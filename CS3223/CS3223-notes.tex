...
\end{itemize}
\centerline{\includegraphics[width = 0.9\linewidth]{sortHash}}
...
\subsection{Query Evaluation Approaches}
...
\subsection{Cost Estimation of Query Plans}
