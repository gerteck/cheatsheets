...
\end{itemize}
\smallskip
\centerline{\includegraphics[width=1\linewidth]{aloha}}
...
\centerline{\includegraphics[width=0.8\linewidth]{lanEthernet}}
...
\smallskip
\centerline{\includegraphics[width=0.8\linewidth]{topo}}
...
\item MAC address commonly aka Ethernet Address.
